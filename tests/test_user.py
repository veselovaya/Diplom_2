...
class TestCreateUser:
    ...
    @allure.title('Создание пользователя с отсутствующими данными')
...
class TestLoginUser:
    ...
    @allure.title('Неуспешная авторизация, если введены некорректные логин/пароль')
    @pytest.mark.parametrize(
        'mistake_data',
...
class TestUpdateUser:
    ...
    @allure.title('Успешное изменение емейла пользователя')
    ...
    @allure.title('Неуспешное изменение пользователя без авторизации')
    @pytest.mark.parametrize(
        'update_data',
        [
